...
const Events = () => {
  ...
  return (
    <div className="text-orange-400 w-full">
      ...
      <div className="grid grid-cols-1  mix-blend-screen  bg-[url(../src/assets/abs.jpg)] bg-contain bg-repeat shadow-insetBlack md:grid-cols-2 place-items-center lg:grid-cols-3 gap-6 p-6">
